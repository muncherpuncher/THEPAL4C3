...
?>
  <section id="container" class="">
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
           <!--  <a href="<?php //echo base_url();?>admin" class="logo"> <img  style="height:50px;margin-top:-8px"src="<?php //echo base_url();?>_assets/palace/img/logo.jpg"></a> -->
            <!--logo end-->
            <p style="color:#ffffff;left:50px;top:22px;position:absolute"> THE PALACE MANILA </p>
