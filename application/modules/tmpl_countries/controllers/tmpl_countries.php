...
class Tmpl_countries extends MX_Controller {
	...
	function get_info_by_alpha2()
	{	
		if($_POST)
		{	
			$alpha_2 = strtolower( trim( $this->input->post('alpha2') ) );
			$query = $this->mdl_tpl_countries->get_where_custom('alpha_2',$alpha_2);
			echo json_encode( array('country' => strtolower( $query->row()->alpha_2 ) ) );
		}
	}
