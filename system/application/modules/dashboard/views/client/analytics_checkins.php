...
$analytics_inter = Modules::run('events/analytics','get','',array('type'=>'checkin','business_id'=>$branch_id));
...
<div class="chart-bar col-lg-6">
	...
	<div class="bar-bg">
		...
		?>
		<div class="bar <?php echo $bar_color;?> tooltips" title="<?php echo $month_value;?>" height="<?php echo $bar_value;?>" data-placement="top" data-trigger="hover"></div>
	</div>
	<?php endfor;?>
