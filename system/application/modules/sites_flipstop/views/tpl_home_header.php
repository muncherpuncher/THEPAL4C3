...
<div class="row text-center">
		  ...
		  <ul class="dropdown-menu menu-dropdown-fs" role="menu">
		    <li>
		    	...
		    	<div class="fs-header-menu">
		    		...
		    		<?php foreach ($listing_categories->result() as $key):?>
		    		<div class="col-md-2 business-types">
		    			<ul>
		    				<li> <img src="<?php echo $template_url_img;?>/menu-icons/<?php echo $key->icon;?>"> </li>
		    				<li> <b> <?php echo ucfirst($key->name);?> </b> </li>
		    				
		    				<?php $child_cat = Modules::run('tmpl_business_categories/get_list_child',$key->id);
		    					  foreach ($child_cat->result() as $key):?>
									<li> <a href="#"> <?php echo ucfirst($key->lev2);?> </a></li>
		    				<?php endforeach;?>
		    			</ul>
		    		</div>
		    		<?php endforeach;?>
	...
	<div class="text-center fs-header-logo">
		<a href="<?php echo base_url();?>"> <img height="70px" src="<?php echo base_url('_assets/'.$template_name.'img/fs_logo_dark.jpg');?>"> </a>
	</div>
	<hr class"hr-fs">
